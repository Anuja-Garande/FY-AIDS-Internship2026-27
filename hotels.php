...
$sql = "SELECT h.*, d.name AS dest_name, s.name AS state_name, s.state_id FROM hotels h
...
<section class="page-banner">
  <div class="container">
    <h1 data-aos="fade-up">Hotels Across India</h1>
    <p class="breadcrumb-custom" data-aos="fade-up" data-aos-delay="100"><a href="/tourism-portal/index.php">Home</a> / Hotels</p>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <form method="get" class="filter-bar row g-3 align-items-center" data-aos="fade-up">
      <div class="col-lg-6">
        <input type="text" name="q" class="form-control" placeholder="Search hotels or destinations" value="<?= h($search) ?>">
      </div>
      <div class="col-lg-4">
    ...
    <p class="text-muted mt-4 mb-4"><?= count($hotels) ?> hotel(s) found</p>
        ...
        <div class="card-tile">
          <div class="tile-img-wrap">
            <img src="/tourism-portal/assets/images/destinations/<?= h($h['image']) ?>" alt="<?= h($h['name']) ?>"
                 onerror="this.src='https://source.unsplash.com/500x400/?hotel,<?= urlencode($h['dest_name']) ?>'">
            <span class="tile-category">Hotel</span>
          </div>
          <div class="tile-body">
            <h5><?= h($h['name']) ?></h5>
